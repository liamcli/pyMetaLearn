...
def plot_summed_wins_of_optimizers(trial_list_per_dataset, name_list,
    ...
    for pkl_list in trial_list_per_dataset:
        ########################################################################
        # Statistical stuff for one dataset
        for c in range(1, cut+1):
            output, wins_of_optimizer_t, wins_of_optimizer_welch = \
                statistics.main(pkl_list, name_list, cut=c)
